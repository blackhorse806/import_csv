...
if(isset($_POST['submit']))
{
	...
	while(($line = fgetcsv($handle, 1000, ",")) !== false)
	{
		...
		$sql = "INSERT INTO unit_timetabling (unit_id, activity_type, activity_hours)
				VALUES ('$unit_id','$activity', '$hour')";
		$result = $conn->query($sql);

		// Import Offering data
		$sql = "INSERT INTO unit_offerings (unit_id, session, location, unit_class, est_num_students, quota)
				VALUES ('$unit_id','Spring', 'Parramatta', 'Day', '50', 'No')";
		$result = $conn->query($sql);
